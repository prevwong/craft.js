                    ...
                    [
                        ...
                        (e) => {
                            ...
                            if (indicatorInfo) {
                                ...
                                if (
                                    this.store.query.node(parent.id).isCanvas()
                                ) {
                                    if (parent.data.parent) {
                                        ...
                                        if (
                                            ...
                                            if (
                                                (e.clientY >
                                                    parentHeadingInfo.bottom -
                                                        10 &&
                                                    !this.getLayer(parent.id)
                                                        .expanded) ||
                                                e.clientY <
                                                ...
                                                indicatorInfo.placement.index = grandparent
                                                    .data.nodes
                                                    ? grandparent.data.nodes.indexOf(
                                                          parent.id
                                                      )
                                                    : 0
                                                if (
