...
export const Toolbox = () => {
  return (
    <div className='flex flex-col items-center'>
      <Selector render={ <Canvas is={Container} background={{ r: 255, g: 255, b: 255, a: 1 }}  color={{ r: 0, g: 0, b: 0, a: 1 }} height="100%" width="50%" paddingTop={2} paddingLeft={2} paddingBottom={2} paddingRight={2}></Canvas>}>
