            ...
            >
                ...
                <DialogContent>
                    <ul className="px-5 list-disc" style={{ opacity: 0.85 }}>
                        <li>
                            Craft.js is an abstraction, this demo is an
                            implementation of it. If you don't like the UI for
                            example, please know that it is the demo and not the
                            framework.
                        </li>
                        <li>
                            This is a beta release. Bugs are to be expected. If
                            you find one, please file an issue at the Github
                            repo
                        </li>
