...
export declare type ChainableConnector<
  T extends Connector,
  O extends any
> = T extends (element: infer E, ...args: infer P) => any
  ? <B extends E | O>(element: B, ...args: P) => B
  : never;
export declare type ChainableConnectors<
...
export declare type CraftEventListener<K extends keyof HTMLElementEventMap> = (
  ev: CraftDOMEvent<HTMLElementEventMap[K]>
) => any;
export declare type EventHandlerConnectors<
