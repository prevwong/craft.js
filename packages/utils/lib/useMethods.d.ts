...
export declare type SubscriberAndCallbacksFor<
...
export declare type StateFor<
  M extends MethodsOrOptions
> = M extends MethodsOrOptions<infer S, any> ? S : never;
export declare type CallbacksFor<
  M extends MethodsOrOptions
...
export declare type MethodsOrOptions<
  S = any,
  R extends MethodRecordBase<S> = any,
  Q = any
> = Methods<S, R, Q> | Options<S, R, Q>;
export declare type MethodRecordBase<S = any> = Record<
  string,
...
export declare type ActionByType<A, T> = A extends {
  ...
  ? T extends T2
    ...
    : never
  : never;
export declare type QueryMethods<
  S = any,
  O = any,
  R extends MethodRecordBase<S> = any
> = (state?: S, options?: O) => R;
export declare type QueryCallbacksFor<
  M extends QueryMethods
...
export declare function useMethods<S, R extends MethodRecordBase<S>>(
...
export declare function createQuery<Q extends QueryMethods>(
  queryMethods: Q,
  getState: any,
  history: History
): QueryCallbacksFor<Q> & {
