...
export const ERROR_ROOT_CANVAS_NO_ID = 'A <Canvas /> that is a child of a non Canvas node must specify an `id` prop, eg: <Canvas id="MyCanvas">...</Canvas> ' 
...
export const ERROR_MOVE_TOP_LEVEL_CANVAS = "A <Canvas /> that is a child of a non-Canvas node cannot be moved";
