            ...
            return (
              ...
              r &&
                r(
                  p,
                  s,
                  { type: a.type, params: a.payload, patches: E },
                  u,
                  function (e) {
                    var t = produce.produceWithPatches(p, e);
                    (c = t[0]),
                      (E = __spreadArrays(E, t[1])),
                      (d = __spreadArrays(t[2], d));
                  }
                ),
              ...
              __spreadArrays(t, [
                ...
                (a.type === HISTORY_ACTIONS.THROTTLE
                  ? i.throttleAdd(E, d, a.config && a.config.rate)
      ...
      function () {
        ...
        return _assign(
          ...
          ),
          {
            history: {
              undo: function () {
                return d({ type: HISTORY_ACTIONS.UNDO });
              },
              redo: function () {
                return d({ type: HISTORY_ACTIONS.REDO });
              },
              clear: function () {
                return d({ type: HISTORY_ACTIONS.CLEAR });
              },
              throttle: function (n) {
                return _assign(
                  {},
