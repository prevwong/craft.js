...
import { SubscriberAndCallbacksFor, PatchListener } from 'craftjs-utils-meetovo';
...
export declare const ActionMethodsWithConfig: {
    methods: (state: EditorState, query: {
        ...
        setState(cb: (state: EditorState, actions: Pick<{
            ...
            setNodeEvent: (eventType: NodeEventTypes, nodeIdSelector: string | string[], source?: string) => void;
...
export declare const useEditorStore: (options: Partial<Options>, patchListener: PatchListener<EditorState, {
    methods: (state: EditorState, query: {
        node: (id: string) => {
            isCanvas(): boolean;
            isRoot(): boolean;
    ...
    ignoreHistoryForActions: readonly ["setDOM", "setNodeEvent", "selectNode", "clearEvents", "setOptions", "setIndicator"];
    normalizeHistory: (state: EditorState) => void;
}, typeof QueryMethods>) => SubscriberAndCallbacksFor<{
    methods: (state: EditorState, query: {
        node: (id: string) => {
            isCanvas(): boolean;
            isRoot(): boolean;
